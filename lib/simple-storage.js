...
class SimpleStorage {
  ...
  static async saveGoalStatus(studentId, type, completed) {
    ...
    // Load existing data first to ensure we have the latest
    this.load();
    ...
    console.log(`[SimpleStorage] Before update for student ${studentId}:`, {
    ...
    data.studentId = studentId; // Ensure studentId is set
    ...
    console.log(`[SimpleStorage] After update - ${type} = ${completed} for student ${studentId}:`, {
      brainlift: data.brainliftCompleted,
      dailyGoal: data.dailyGoalCompleted,
      key: key
    });
