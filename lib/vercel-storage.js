...
// Check for both standard KV_ and Data_KV_ prefixes (Upstash uses Data_ prefix)
try {
  const kvUrl = process.env.KV_REST_API_URL || process.env.Data_KV_REST_API_URL;
  const kvToken = process.env.KV_REST_API_TOKEN || process.env.Data_KV_REST_API_TOKEN;
